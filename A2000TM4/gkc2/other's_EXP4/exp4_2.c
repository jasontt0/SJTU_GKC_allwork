...
// 各模块内容
/*unsigned*/ char str[7][10] = {"工作模式：", "模式A", "工作参数：",  "1",   ".",   "1", "Hz"};
...
{
	clear_screen();
	//display_GB2312_string(1, 1, "                          ", 0);//第一行
	...
	//display_GB2312_string(7, 1, "                          ", 0);//第四行
	//display_GB2312_string(3, (16-1)*8+1, "  ", 0);        //第二行末
	//display_GB2312_string(5, (16-1)*8+1, "  ", 0);        //第四行末
}
