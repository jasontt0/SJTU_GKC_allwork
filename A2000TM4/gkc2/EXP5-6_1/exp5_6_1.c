...
int main(void)
{
	...
	while (1)
	{
		...
		//DelayMilliSec(100000);
		//trans_temp()

		/*
		if (clock1s_flag == 1) // 刷新温度显示
		{
			clock1s_flag = 0;
			refresh_temp_in();
			PWMStart(523);
...
void trans_temp(void)	
{
	...
	// freq_square =92.5*(temp2[1]*100+temp2[2]*10+temp2[3])+300;
